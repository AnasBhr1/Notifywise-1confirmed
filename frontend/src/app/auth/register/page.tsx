...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.whatsappNumber.length < 10 || formData.whatsappNumber.length > 15) {
      toast({
        title: "Invalid WhatsApp number",
        description: "WhatsApp number must be 10-15 digits.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      await register(formData.email, formData.password, formData.businessName.trim(), formData.whatsappNumber);
      toast({
                  ...
                  >
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Input
                          type="tel"
                          placeholder="Enter WhatsApp number (10-15 digits)"
                        ...
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Enter 10-15 digits only (without + or country code)
                        </p>
                      </div>
